                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => {
                                        setValue({
                                            ...value,
                                            parentsNum: { ...value.parentsNum, 1: e.target.value },
                                        });
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        setValue({
                                            ...value,
                                            parentsNum: { ...value.parentsNum, 2: e.target.value },
                                        });
                                    }}
                                />
                                <input
                                    ...
                                    onChange={(e) => {
                                        setValue({
                                            ...value,
                                            parentsNum: { ...value.parentsNum, 3: e.target.value },
                                        });
                                    }}
                                />
                            </td>
        ...
        <tr>
            <td>
                <SelectBase
                    ...
                    onChange={(ele) =>
                        setValue({ ...value, ["진단평가학년" + (index + 2)]: ele })
                    }
                />
                <SelectBase
                    defaultValue="학기"
                    ...
                    onChange={(ele) =>
                        setValue({ ...value, ["진단평가학기" + (index + 2)]: ele })
                    }
                />
