...
const arr =[
    ...
    'info',            'lbt1',              'lbt2',
    'lbt3',            'lbt4',              'lbt5',
    'lbt6',            'lnbDetail',         'logout',
    'menu_btn(close)', 'more',              'notification',
    'pencil',          'play',              'plus',
    'plusLearning',    'point',             'print',
    'reload',          'remove',            'search',
    'selct_typeC',     'select_typeA',      'select_typeB',
    'select_typeC',    'studentManagement', 'todayClass',
    'volume',          'warning'
  ];
